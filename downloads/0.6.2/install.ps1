...
function downloadDvm([string] $dvmDir) {
  ...
  $webClient.DownloadFile("https://howtowhale.github.io/dvm/downloads/0.6.2/dvm.ps1", "$dvmDir\dvm.ps1")

  echo "Downloading dvm.cmd..."
  $webClient.DownloadFile("https://howtowhale.github.io/dvm/downloads/0.6.2/dvm.cmd", "$dvmDir\dvm.cmd")
  ...
  # Download 0.6.2 release
  $webClient.DownloadFile("https://howtowhale.github.io/dvm/downloads/0.6.2/Windows/$arch/dvm-helper.exe", "$tmpDir\dvm-helper.exe")
  $webClient.DownloadFile("https://howtowhale.github.io/dvm/downloads/0.6.2/Windows/$arch/dvm-helper.exe.sha256", "$tmpDir\dvm-helper.exe.256")
