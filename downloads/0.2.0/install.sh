...
install_dvm_helper() {
  ...
  url=https://download.getcarina.com/dvm/0.2.0/$DVM_OS/$DVM_ARCH/dvm-helper
...
dvm_download -L --progress-bar https://download.getcarina.com/dvm/0.2.0/dvm.sh -o $DVM_DIR/dvm.sh

echo "Downloading bash_completion"
dvm_download -L --progress-bar https://download.getcarina.com/dvm/0.2.0/bash_completion -o $DVM_DIR/bash_completion
