...
function downloadDvm([string] $dvmDir) {
  ...
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.1.4/dvm.ps1", "$dvmDir\dvm.ps1")

  echo "Downloading dvm.cmd..."
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.1.4/dvm.cmd", "$dvmDir\dvm.cmd")
  ...
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.1.4/Windows/$arch/dvm-helper.exe", "$tmpDir\dvm-helper.exe")
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.1.4/Windows/$arch/dvm-helper.exe.sha256", "$tmpDir\dvm-helper.exe.256")
