...
install_dvm_helper() {
  ...
  url=https://download.getcarina.com/dvm/0.1.4/$DVM_OS/$DVM_ARCH/dvm-helper
...
dvm_download -L --progress-bar https://download.getcarina.com/dvm/0.1.4/dvm.sh -o $DVM_DIR/dvm.sh
