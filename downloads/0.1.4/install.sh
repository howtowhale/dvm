...
install_dvm_helper() {
  ...
  url=https://howtowhale.github.io/dvm/downloads/0.1.4/$DVM_OS/$DVM_ARCH/dvm-helper
...
dvm_download -L --progress-bar https://howtowhale.github.io/dvm/downloads/0.1.4/dvm.sh -o $DVM_DIR/dvm.sh
