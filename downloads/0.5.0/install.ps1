...
function downloadDvm([string] $dvmDir) {
  ...
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.5.0/dvm.ps1", "$dvmDir\dvm.ps1")

  echo "Downloading dvm.cmd..."
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.5.0/dvm.cmd", "$dvmDir\dvm.cmd")
  ...
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.5.0/Windows/$arch/dvm-helper.exe", "$tmpDir\dvm-helper.exe")
  $webClient.DownloadFile("https://download.getcarina.com/dvm/0.5.0/Windows/$arch/dvm-helper.exe.sha256", "$tmpDir\dvm-helper.exe.256")
